...
df_all = pd.read_csv(root + "Aaron\ProstateMRL\Data\\Paper1\\HM-FSTP\\Features\\All_fts_pICC.csv")
...
print(fts_remove)
fts_remove.to_csv(root + "Aaron\ProstateMRL\Data\Paper1\\HM-FSTP\\Features\\FeaturesRemoved_Volume.csv", index=False)

# save to csv
df_all.to_csv(root + "Aaron\ProstateMRL\Data\Paper1\\HM-FSTP\\Features\\All_fts_pVol.csv", index=False)
