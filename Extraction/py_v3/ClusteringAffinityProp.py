...
out_dir = "D:\\data\\Aaron\\ProstateMRL\\Data\\MRLPacks\\Clustering\\AffinityPropagation\\"
...
for n in tqdm(Norms):
    ...
    for pat in patIDs:
        ...
        cluster = sc.AffinityPropagation(max_iter=1000, convergence_iter=50, random_state=None)
        cluster.fit(arr_DM)
        ...
        df_out.to_csv(out_dir + "Labels\\" + pat + "_" + n + "_ClusterLabel.csv")
