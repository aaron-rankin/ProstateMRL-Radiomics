...
for t in treatments:
    ...
    for i in patIDs:
        ...
        for j in scans:
            ...
            factors_labels = ["Norm-Pros", "Med-Pros", "Norm-Glute", "Med-Glute", "Norm-Psoas", "Med-Psoas"]
            ...
            for l in range(0,6,2):
                ...
                mean_path = pat_path + factors_labels[l] + "\\" + str(i) + "_" + MRcont + "_" + factors_labels[l] + "_v2.nii"
                med_path = pat_path + factors_labels[l+1] + "\\" + str(i) + "_" + MRcont + "_" + factors_labels[l+1] + "_v2.nii"
