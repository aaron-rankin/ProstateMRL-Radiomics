...
df_all = pd.read_csv(root + "Aaron\ProstateMRL\Data\Paper1\\HM-FSTP\\Features\\All_fts_pVol.csv")
...
for pat in tqdm(patIDs):
    ...
    df_dist.to_csv(root + "Aaron\ProstateMRL\Data\Paper1\\HM-FSTP\\Longitudinal\\DM\\csvs\\" + str(pat) + ".csv")
    ...
    plt.savefig(root + '\\Aaron\\ProstateMRL\\Data\\Paper1\\HM-FSTP\\Longitudinal\\DM\\Figs\\' + str(pat) + '.png')
