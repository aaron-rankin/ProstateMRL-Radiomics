...
df_all = pd.read_csv(root + "Aaron\ProstateMRL\Data\Paper1\FeaturesHM\\All_fts_pVol.csv")
...
for pat in tqdm(patIDs):
    ...
    df_dist.to_csv(root + "Aaron\ProstateMRL\Data\Paper1\Longitudinal\\DM\\csvs\\HM_" + str(pat) + ".csv")
    ...
    plt.savefig(root + '\\Aaron\\ProstateMRL\\Data\\Paper1\\Longitudinal\\DM\\Figs\\HM_' + str(pat) + '.png')
